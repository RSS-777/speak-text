...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-violet-950 to-violet-900 text-white mt-12 p-6 select-none">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
        ...
        <div className="max-w-full md:col-span-1 md:justify-self-end">
